...
import com.gestion.empleados.entidades.service.EmpleadoService;
...
public class EmpleadoController {
	...
	@PostMapping("/form")
	public String guardarEmpleado(@Valid Empleados empleado,BindingResult result,Model modelo,RedirectAttributes flash,SessionStatus status) {
		if(result.hasErrors()) {
